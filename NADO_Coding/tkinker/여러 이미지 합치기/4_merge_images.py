...
def merge_image():
    ...
    # [(10, 10), (20,20), (widths, heights)]

    # zip을 이용하여 widths와 heights 정보 처리
    ...
    dest_path = os.path.join(txt_dest_path.get(), "merge_image.jpg")
...
cmb_space = ttk.Combobox(frame_option, state="readonly", values=opt_space, width=15)
cmb_space.current(0)
...
# 3. 파일 포맷 옵션
# 파일 포맷 옵션 레이블
lbl_format = Label(frame_option, text="파일 포맷", width=8)
lbl_format.pack(side="left", padx=5, pady=5)

# 파일 포맷 옵션 콤보
opt_format = ["PNG", "JPG", "BMP"]
cmb_format = ttk.Combobox(frame_option, state="readonly", values=opt_format, width=15)
